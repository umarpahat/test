    ...
    <body>
        <div class="nav">
          ...
          <g:if test="${session?.user}">
           <div style="text-align:right;">Welcome :  ${session.user.name}  <g:link controller="home" action="logout"  >Logout</g:link></div>
          </g:if>
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.readableItems.label" default="Readable Items" /></td>
