                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="readableItems"><g:message code="user.readableItems.label" default="Readable Items" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'readableItems', 'errors')}">
                                    
<ul>
<g:each in="${userInstance?.readableItems?}" var="r">
    <li><g:link controller="readableItem" action="show" id="${r.id}">${r?.encodeAsHTML()}</g:link></li>
</g:each>
</ul>
<g:link controller="readableItem" action="create" params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'readableItem.label', default: 'ReadableItem')])}</g:link>
