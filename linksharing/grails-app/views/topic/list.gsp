                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="topicType" title="${message(code: 'topic.topicType.label', default: 'Topic Type')}" />
                    ...
                    <g:each in="${topicInstanceList}" status="i" var="topicInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: topicInstance, field: "creator.name")}</td>
                        
                            <td>${fieldValue(bean: topicInstance, field: "topicName")}</td>
                        
                            <td>${fieldValue(bean: topicInstance, field: "topicType")}</td>
